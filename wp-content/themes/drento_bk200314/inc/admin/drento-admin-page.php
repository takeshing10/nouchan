		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'drento_pro_theme_url', 'https://crestaproject.com/demo/drento/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'drento' ); ?></a>

					<a href="<?php echo esc_url( apply_filters( 'drento_pro_theme_url', 'https://crestaproject.com/demo/drento-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'drento' ); ?></a>
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							<a href="<?php echo esc_url( apply_filters( 'drento_pro_theme_url', 'https://crestaproject.com/demo/drento-pro/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View PRO version demo', 'drento' ); ?></a>
